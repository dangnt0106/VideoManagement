...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.VIDEO_MANAGEMENT_PAGE, new PageInfo("Videos","/admin/videos/videos.jsp", null));
		...
		pageRoute.put(PageType.SITE_FAVORITES_PAGE, new PageInfo("Favorites Page","/sites/users/favorites.jsp", null));
		pageRoute.put(PageType.SITE_VIDEO_DETAIL_PAGE, new PageInfo("Video detail Page","/sites/users/detail.jsp", null));
		pageRoute.put(PageType.SITE_SHARE_PAGE, new PageInfo("Shares Page","/sites/videos/share.jsp", null));
	}	
